    ...
    public class InProcessGeomancyService : IGeomancyService
    {
        ...
        private static PerfectionModel MapToPerfectionModel(ContractModels.PerfectionResponse? src)
        {
            ...
            return new PerfectionModel
            {
                ...
                AspectDirection = src.AspectDirection ?? string.Empty,
                AspectFromHouse = src.AspectFromHouse,
                AspectToHouse = src.AspectToHouse,
                PathFromHouse = src.PathFromHouse,
                PathToHouse = src.PathToHouse,
                PathFigure = src.PathFigure ?? string.Empty,
                PathSecondaryFigure = src.PathSecondaryFigure ?? string.Empty,
                PathActor = src.PathActor ?? string.Empty,
                TranslatorHouseSecondary = src.TranslatorHouseSecondary,
