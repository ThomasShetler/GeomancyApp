    ...
    public static class GeomancyHandlers
    {
        ...
        private static PerfectionResponse ToPerfectionResponseWithoutScoring(PerfectionResult perfection, HouseChart houseChart, int querentHouse, int quesitedHouse)
        {
            ...
            return new PerfectionResponse
            {
                ...
                AspectFromHouse = perfection.AspectFromHouse,
                AspectToHouse = perfection.AspectToHouse,
                PathFromHouse = perfection.PathFromHouse,
                PathToHouse = perfection.PathToHouse,
                PathFigure = perfection.PathFigure ?? string.Empty,
                PathSecondaryFigure = perfection.PathSecondaryFigure ?? string.Empty,
                PathActor = perfection.PathActor ?? string.Empty,
                TranslatorHouseSecondary = perfection.TranslatorHouseSecondary,
